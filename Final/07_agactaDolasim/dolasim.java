public class dolasim // ikili agaç yapımızı oluşturduk
{
    ...
    void inOrder(Node root) // inorder fonksiyonu ile kökü ortaya yazıp önce sol değerleri ve sonra sağ değerleri sırasıyla yazmasını sağladık
    {
        if( root != null)
        {            
            inOrder(root.left);
    ...
    void postOrder(Node root) // postorder fonksiyonu ile kökü en sona yazıp önce sol değerleri ve sonra sağ değerleri sırasıyla yazmasını sağladık
    {
        if( root != null)
        {            
            postOrder(root.left);
